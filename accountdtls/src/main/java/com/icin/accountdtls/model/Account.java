...
public class Account {
	...
	public Account(String accountNo, String type, double balance, String chqBkReqStat,String
			accessLevel) {
		super();
		this.accountNo = accountNo;
		this.type = type;
	...
	public Account(int accountId, String accountNo, String type, double balance, String chqBkReqStat,
